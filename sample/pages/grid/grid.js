...
(function () {
    ...
    function dataRequested(e) {
        ...
        request.data.setDataProvider("CHBase.ItemTypes." + CHBase.ItemTypes.Weight.typeID, dataShareItems);
        request.data.setDataProvider("CHBase.Types.RecordItem", dataShareItems);
    }
    ...
    function dataShareItems(request) {
        ...
        record.getAllItemsAsync(query).then(function (items) {
            request.setData(CHBase.Types.RecordItem.serializeMultiple(items));
            deferral.complete();
        },
        function () {
            deferral.complete();
