(function() {
    ...
    var weightDataContract = "CHBase.ItemTypes." + CHBase.ItemTypes.Weight.typeID;
    var bloodPressureDataContract = "CHBase.ItemTypes." + CHBase.ItemTypes.BloodPressure.typeID;
    ...
    function shareReady(eventArgs) {
        CHBase.ItemTypes.ItemTypeManager.init();
        ...
        if (shareOperation.data.contains(weightDataContract)) {
            shareOperation.data.getTextAsync(weightDataContract).done(function (customFormatString) {
                var items = CHBase.Types.RecordItem.deserializeToTypedItems(customFormatString);
